var EmployeesManager = (function () {

    function EmployeesManagerInner() {
        ...
        var initGrid = function (options) {
            ...
            return {
                ...
                columns: [
                    ...
                    {
                        dataField: "Address", caption: captions["address"], minWidth: 120,
                        allowSorting: false,
                        allowFiltering: true,
                        allowHeaderFiltering: false,
                        filterOperations: FilterLst,
                    ...
                    {
                        dataField: "MobileNumber1", caption: captions["mobileNumber1"], minWidth: 120,
                        allowSorting: false,
                        allowFiltering: true,
                        allowHeaderFiltering: false,
                        filterOperations: FilterLst,
                        ...
                        dataType: "string",
                        calculateDisplayValue: function (row) {
                            return row.MobileNumber1;
                        },
                        allowHeaderFiltering: false,
                    },
                    {
                        dataField: "MobileNumber2", caption: captions["mobileNumber2"], minWidth: 120,
                        alignment: "right",
                        dataType: "string",
                        allowFiltering: true,
                        allowSorting: false,
                    ...
                    },
                    {
                        ...
                        cellTemplate: function (content, row) {
                            ...
                            var id = row.data.ID;
                            content.append("<a class='btn btn-sm btn-danger' onclick='EmployeesManager.Instance.OnDeleteRow(" + id + ")'>" + options["delete_text"] + "</a>");
                        },
    ...
    return {
        Instance: (function () {
            if (!instance)
                instance = new EmployeesManagerInner();
            return instance;
        })()
    }
})();