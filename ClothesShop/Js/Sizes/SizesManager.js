var SizesManager = (function () {

    function SizesManagerInner() {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        cellTemplate: function (content, row) {
                            ...
                            var id = row.data.ID;
                            content.append("<a class='btn btn-sm btn-danger delete-order-btn' onclick='SizesManager.Instance.OnDeleteRow(" + id + ")'>" + options["delete_text"] + "</a>");
                        },
    ...
    return {
        Instance: (function () {
            if (!instance)
                instance = new SizesManagerInner();
            return instance;
        })()
    }
})();