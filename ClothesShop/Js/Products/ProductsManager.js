var ProductsManager = (function () {
        ...
        var initGrid = function (options) {
            ...
            return {
                ...
                columns: [
                    ...
                    {
                        dataField: "Colors", caption: captions["colors"], minWidth: 120,
                        allowSorting: false,
                        ...
                        dataType: "string",
                        calculateDisplayValue: function (row) {
                            return row.ColorNames;
                        }
                    },
                    {
                        dataField: "Sizes", caption: captions["sizes"], minWidth: 120,
                        allowSorting: false,
                        allowFiltering: false,
                        allowHeaderFiltering: false,
                        filterOperations: FilterLst,
                    ...
                    },
                    {
                        ...
                        cellTemplate: function (content, row) {
                            ...
                            var id = row.data.ID;
                            content.append("<a class='btn btn-sm btn-danger delete-order-btn' onclick='ProductsManager.Instance.OnDeleteRow(" + id + ")'>" + options["delete_text"] + "</a>");
                        },
    ...
    return {
        Instance: (function () {
            if (!instance)
                instance = new ProductsManagerInner();
            return instance;
        })()
    }
})();