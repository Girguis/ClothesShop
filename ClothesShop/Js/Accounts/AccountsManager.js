var AccountsManager = (function () {
        ...
        var initGrid = function (options) {
            ...
            return {
                ...
                columns: [
                    ...
                    {
                        dataField: "UserName", caption: captions["userName"], minWidth: 120,
                        allowSorting: false,
                        allowFiltering: true,
                        allowHeaderFiltering: false,
                        filterOperations: FilterLst,
                    ...
                    },
                    {
                        ...
                        cellTemplate: function (content, row) {
                            ...
                            var id = row.data.ID;
                            content.append("<a class='btn btn-sm btn-danger delete-order-btn' onclick='AccountsManager.Instance.OnDeleteRow(" + id + ")'>" + options["delete_text"] + "</a>");
                        },
    ...
    return {
        Instance: (function () {
            if (!instance)
                instance = new AccountsManagerInner();
            return instance;
        })()
    }
})();